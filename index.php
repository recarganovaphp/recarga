...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-129034864-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-129034864-1');
</script>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="recharge-left-form">
                    <h3>Recarregue Aqui</h3>
                    <form action="pagamento.php" method="POST">
                        <div class="radio-btn-group">
                      
                        </div>
                        <div class="input-group">
                            <label for="numero">Insira o Número de Celular</label>
                            <input type="text" maxlength="13" autocomplete="no" name="numero" id="numero" placeholder="Insira seu DDD e o Número " onkeypress="formatar('## ##### ####', this)" required>
                            <label for="operadora">Insira a Operadora</label>
                            <input type="text" name="operadora" id="operadora" placeholder="Claro, Oi, Vivo, Tim, Nextel"required>

                            <label>Valor da Recarga</label>
                        
                             <select class="form-control js-price"  data-text-invalid="Escolha o valor" placeholder="Valor" required>
                                    <option>Valor</option>
                                     <option>Pague R$100 Receba R$100</option>
                                      <option>Pague R$30 Receba R$60</option>
                                       <option>Pague R$20 Receba R$40</option>
                                        <option>Pague R$15 Receba R$30</option>
                                         <option>Pague R$10 Receba R$20</option>
                        ...
                        <input type="submit" value="Fazer Recarga">
                    </form>
                </div>
            </div>
            <div class="col-md-7">
